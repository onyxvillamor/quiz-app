const questions = [
  ...
  {
    question: "Who created the ILOVEYOU virus? ",
    answers: [
      { text: "Adrian Lamo", correct: false },
      { text: "Mark Abene", correct: false },
      { text: "Onel de Guzman", correct: true },
      { text: "Christian Reyes", correct: false },
    ]
  },
  {
    question: "Which of these is the smallest continent in the world? ",
    answers: [
